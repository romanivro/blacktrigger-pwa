...
import { saveLog, toggleLog, renderLog, updateActivityChart } from "./core/log.js";
...
import { addWorkout, loadWorkouts, updateFitChart } from "./core/fitness.js";
import { startTest } from "./core/archetype.js";
import { addGoal, loadStrategy } from "./core/strategy.js";

// Привязка к window для кнопок
...
// Глобальные действия при загрузке
